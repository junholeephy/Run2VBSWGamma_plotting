...
#include "EDBRHistoMaker_data.h"

void loopPlot_fake_signal(){
...
//  double lumiValue = 10.0; 
  double lumiValue = 5.776;  //12.70;  //5.80  //2.60;  // 4.30;
...
//	bool dopileupreweight = true;	
  ...
  /// Path to wherever the files with the trees are. 
    std::string pathToTrees="../PKUTree/outtree_170902/";
  ...
  std::string dataLabels[nDATA]={"outSingleMuon_Run2016B"};
  //,"outSingleMuon_Run2016C","outSingleMuon_Run2016D","outSingleMuon_Run2016E","outSingleMuon_Run2016F","outSingleMuon_Run2016G","outSingleMuon_Run2016H"};
//	std::string dataLabels[nDATA]={"outSingleMuon_Run2016B","outSingleMuon_Run2016C","outSingleMuon_Run2016D","outSingleMuon_Run2016E","outSingleMuon_Run2016F","outSingleMuon_Run2016G"};
...
//	std::string mcLabels[nMC]={"ST","TTG","TTJets","VV","ZJets","ZG","WJets","WG"};
	std::string mcLabels[nMC]={"ST","TTG","VV","ZG","WJets","ZJets","TTJets","WG"};
...
std::string mcLabelsSig[nMCSig]={"outVBS_WGamma_signal"};
...
//error down here
      ...
      if(redoHistograms) {
      EDBRHistoMaker_data* maker_data = new EDBRHistoMaker_data(treeData,
                        fileData,
                        hisRatio,
                        wantElectrons,
						 wantMuons,
