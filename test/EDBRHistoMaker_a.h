...
/*    hs.setHisto("nVtx", 10, -0.5, 35);
    hs.setHisto("photonet", 10,20,400);
    hs.setHisto("Mjj", 8,400,2400);
    hs.setHisto("photoneta", 10,-2.5,2.5);
    hs.setHisto("ptVlepJEC", 10,0,1000);
    hs.setHisto("mtVlepJECnew", 10,0,200);
    hs.setHisto("photonsieie", 10,0,0.02);
    hs.setHisto("photonphoiso", 40,0,10.);
    hs.setHisto("ptlep1", 10, 30,330);
    hs.setHisto("etalep1", 10,-2.5,2.5);
///////    
	hs.setHisto("zepp",10,0.0,3.5);
	hs.setHisto("photonphi",10,-4,4);
	hs.setHisto("photon_pt",10,20,400);
	hs.setHisto("jet1eta",10,0,5);
	hs.setHisto("jet2eta",10,0,5);
	hs.setHisto("jet1phi",10,0,3.2);
	hs.setHisto("jet2phi",10,0,3.2);
	hs.setHisto("eta_jj",8,2.4,5.2);
	hs.setHisto("phi_jj",10,0,3.2);
	hs.setHisto("jet1pt",10,40,340);
	hs.setHisto("jet2pt",10,30,230);
    hs.setHisto("MET_et",10,35,185); */
 ...
 // double lumivalue = 0.57831;
  ...
  Long64_t nbytes = 0, nb = 0;
   ...
   //      actualWeight = lumiWeight*pileupWeight*scalef;
              if(photonet>=20 && photonet<30) actualWeight=0.298/2.6;
			          else if(photonet>=30 && photonet<40) actualWeight=0.167/2.6;
					          else if(photonet>=40 && photonet<50) actualWeight=0.135/2.6;
							          else if(photonet>=50 && photonet<60) actualWeight=0.116/2.6;
			  else if(photonet>=60 && photonet<70) actualWeight=0.116/2.6;
			  else if(photonet>=70 && photonet<80) actualWeight=0.101/2.6;
...
//		if(photonet>20 && photonet<30) actualWeight=0.278;
//		else if(photonet>30 && photonet<40) actualWeight=0.161;
//		else if(photonet>40 && photonet<50) actualWeight=0.133;
//		else if(photonet>50 && photonet<400) actualWeight=0.086;
            int iswjets = 0;
            int isnotwets = 0;
            int iszjets = 0;
            int isttjets = 0;
