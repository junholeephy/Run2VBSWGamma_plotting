...
MC_inte = histo->Integral();  cout<<"background !!!!!!!"<<MC_inte<<endl;
...
num_inte1 = histoOrig->Integral(); cout<<"num inte !!!!!!!!!!!!!!"<<num_inte1<<endl;
...
*/
	if(i==0) {leg->AddEntry(histosMC.at(i), "ST", "f"); continue; }
	if(i==1) {leg->AddEntry(histosMC.at(i), "TTG", "f"); continue; }
	if(i==2) {leg->AddEntry(histosMC.at(i), "VV", "f"); continue; }
	if(i==3) {leg->AddEntry(histosMC.at(i), "ZG", "f"); continue; }
	if(i==4) {leg->AddEntry(histosMC.at(i), "WJets", "f"); continue; }
	if(i==5) {leg->AddEntry(histosMC.at(i), "ZJets", "f"); continue; }
	if(i==6) {leg->AddEntry(histosMC.at(i), "TTJets", "f"); continue; }
	if(i==7) {leg->AddEntry(histosMC.at(i), "WG", "f"); continue; }
	}
